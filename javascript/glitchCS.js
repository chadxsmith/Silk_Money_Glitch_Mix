 $( document ).ready(function() {
  ...
  $.ajax({
          type: 'GET',
          dataType: 'json',
          url:"http://api.giphy.com/v1/gifs/search?q=vaporwave&api_key=dc6zaTOxFJmzC&limit=10"
          ...
          for(i = 0; i < response["data"].length; i++){
              ...
              //set interval every 13 to:
              //remove #canvus 
              // add #canvus
              // append gify to img source    

              // $(".source").append("<img src=" + response["data"][i]["images"]["downsized"]["url"] + ">")
              $(".source").css("background-image"," + response["data"][i]["images"]["downsized"]["url"] + ");
          //  $(".source").css('background-image','url(/images/stop.png)');

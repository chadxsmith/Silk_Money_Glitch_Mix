...
setInterval(function () {
     ...
     var timesCounter = Math.random() * 180

      background(200, timesCounter, 200, 1);

      // console.log("the number is " + timesCounter)
    
      copy(cnv,0,decrement,width,height,timesCounter,speed,width,height);
      decrement--
